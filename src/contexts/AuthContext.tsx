...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const register = async () => {
    try {
      ...
      const { passkeyInfo, publicKey: derivedPublicKey } =
      ...
      if (
        !passkeyInfo ||
        !passkeyInfo.id ||
        passkeyInfo.id === "demo-passkey-id"
      ) {
        ...
        if (window.location.hostname.includes("github.com")) {
          ...
          toast({
            ...
            description: `Using demo passkey. Your Solana address: ${derivedPublicKey
              .toString()
              .slice(0, 8)}...`,
          });
          return;
      ...
      toast({
        ...
        description: `Your passkey has been created. Your Solana address: ${derivedPublicKey
          .toString()
          .slice(0, 8)}...`,
      });
    } catch (err: any) {
  ...
  const login = async () => {
    try {
      ...
      toast({
        ...
        description: `You are now logged in. Your Solana address: ${derivedPublicKey
          .toString()
          .slice(0, 8)}...`,
      });
    } catch (err: any) {
